...
- `LICENSE-CHANGE` rewritten — "first public release" ambiguity resolved; Change Date is now explicitly the earlier of (release-tag + 4 years) or the 2030-03-13 hard cap. Product name corrected from "RustHSM Enterprise" to "Craton HSM Enterprise".
...
- Business Source License 1.1 (change date 2030-03-13 to Apache 2.0)
